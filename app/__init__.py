...
def register_blueprints(app):
    ...
    # Recruiter Auth blueprint
    from app.blueprints.auth_recruiter.routes import auth_recruiter_bp
    app.register_blueprint(auth_recruiter_bp)

    # Recruiter Dashboard blueprint
